...
<!--                     <li class="dropdown">
	...
	<div class = "container">
		...
		<div class = "row">
			<table class = "table table-hover">
				...
				%>
					<tr class="table-body">
						<td><a href="bulletinNoticeView.jsp?bulletinID=<%=list.get(i).getBulletinID()%>"> <%=list.get(i).getBulletinTitle() %></a></td>
			...
			%>
			<a href = "bulletinNotice.jsp?pageNumber=<%= pageNumber +1 %>" class= "btn btn-success btn-arrow-left">이전</a>
			...
			<%
				...
				if(pageNumber != 1){
			%>
			<a href = "bulletinNotice.jsp?pageNumber=<%= pageNumber -1 %>" class= "btn btn-success btn-arrow-left">다음</a>
	...
	<div class = "container">
		<div class = "row">
			...
			<a href= "write.jsp"class="btn btn-primary pull-right">글쓰기</a>  <!-- 관리자 글 쓰기  -->
		</div>
	...
	<div class = "container">
		...
		<div class = "row">
			...
			<a href= "#"  onclick="btn_is_alert_click();" class="btn btn-primary pull-right">글쓰기</a>
		</div>
