...
<body>
	...
	<div class = "container-main">
			<div class="btn-group" role="group" aria-label="...">
			  <a type="button" class="btn btn-default active" href="mobile_bulletinNotice.jsp">공지사항</a>
			  <a type="button" class="btn btn-default" href="mobile_bulletinIntroduction.jsp">가입인사</a>
			  <a type="button" class="btn btn-default" href="mobile_bulletin.jsp">봉사 후기</a>
			</div>
			<br>
		<div class = "row">
			...
			<table class = "table table-hover list">
				...
				<%
					...
					ArrayList<Bulletin> list = bulletinDAO.getNoticeList(pageNumber);
					for(int i = 0; i< list.size(); i++){
				%>
					<tr>
						<td colspan='2'><a class="title-line" href="mobile_bulletinNoticeView.jsp?bulletinID=<%=list.get(i).getBulletinID()%>"> <%= list.get(i).getBulletinTitle() %></a></td>
					</tr>
					<tr>
			...
			<%
				if(bulletinDAO.nextPage(pageNumber + 1,2)){
			%>
			<a href = "mobile_bulletinNotice.jsp?pageNumber=<%= pageNumber +1 %>" class= "btn btn-success btn-arrow-left pull-left">이전</a>
			...
			<%
				...
				if(pageNumber != 1){
			%>
			<a href = "mobile_bulletinNotice.jsp?pageNumber=<%= pageNumber -1 %>" class= "btn btn-success btn-arrow-left pull-left">다음</a>
	...
	<div class = "container-main">
		...
		<div class = "row">
			...
			<a href= "mobile_write.jsp"class="btn btn-primary pull-right">글쓰기</a>  <!-- 관리자 글 쓰기  -->
		</div>
	...
	<div class = "container-main">
		...
		<div class = "row">
			...
			<a href= "#"  onclick="btn_is_alert_click('관리자 기능입니다.');" class="btn btn-primary pull-right">글쓰기</a>
		</div>
