...
<body>
	...
	if(session.getAttribute("user") != null){
		...
		Volunteer volunteer = new VolunteerDAO().getVolunteer(volunteerID);
	 	...
	 	if(!userID.equals(volunteer.getUserID())  && !userID.equals("admin") ){
			PrintWriter script = response.getWriter();
			script.println("<script>");
...
<!--                     <li class="dropdown">
	...
	<!-- 관리자 계정에서 글쓰기 할 경우 -->
		...
		%>
		<!-- 관리자 계정 게시판 열람 경우 - 공지 업데이트의 경우 일반계정과 관리자 계정 구분이 필요가없음 -->
	<div class = "container">
		<div class = "row">
		
			<form method = "post" action="volunteerUpdateAction.jsp?volunteerID=<%=volunteerID%>">
				<table class = "table table-striped"style= "text-align : center; border: 1px solid #dddddd">
					
					<thead>
						<tr>
							<th colspan="2" style ="background-color: #eeeeee; text-align: center; "> 봉사 공지 수정 </th>
					...
					<tbody>
						...
						<tr>
							<td><input type ="text" class="form-control" placeholder="봉사 제목" name = "volunteerTitle" maxlength ="50" value="<%=volunteer.getVolunteerTitle()%>"  ></input></td>
						</tr>
						
						<tr>
							<td><input type ="text" class="form-control" placeholder="봉사 일자" name = "volunteerDate" maxlength ="50"value="<%=volunteer.getVolunteerDate()%>"  ></input></td>
						</tr>
						
						<tr>
							<td><input type ="text" class="form-control" placeholder="봉사 장소" name = "volunteerPlace" maxlength ="50" value="<%=volunteer.getVolunteerPlace()%>" ></input></td>
						</tr>
						
						<tr>
							<td><textarea class="form-control" placeholder="봉사 내용" name = "volunteerContent" maxlength ="2048" style= "height: 350px;"><%=volunteer.getVolunteerContent()%>> </textarea></td>
						</tr>
				
						<tr>
							<td><input type ="text" class="form-control" placeholder="식사 내용" name = "foodName" maxlength ="50" value="<%=volunteer.getFoodName()%>" ></input></td>
						</tr>
						
						<tr>
							<td><input type ="text" class="form-control" placeholder="식사 가격" name = "foodPrice" maxlength ="50" value="<%=volunteer.getFoodPrice()%>" ></input></td>
						</tr>
						<tr>
							<td>
								<p>마감날짜 입력 : </p>
...
<%-- 	<div class = "container">
		<div class = "row">
			...
			<form method = "post" action="updateAction.jsp?bulletinID=<%= bulletinID %>">
				<table class = "table table-striped"style= "text-align : center; border: 1px solid #dddddd">
