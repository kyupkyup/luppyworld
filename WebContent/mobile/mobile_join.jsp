...
<body>
	...
	<div class = "container-main">  <!--  회원가입 정보 입력 창 -->
		...
		<div class = "jumbotron" style= "padding-top: 20px">
			<form method = "post" action="mobile_joinAction.jsp" id = "form" name = "form" enctype="multipart/form-data">
				<h3 style = "text-align: center;">회원 가입</h3>
					...
					<div class="form-group userEmail">			
						<input type = "text" class = "form-control" placeholder = "이메일" name = "userEmail" maxlength = "100">
					</div>
					...
					<div class="form-group userJob">			
						<input type = "text" class = "form-control" placeholder = "직업" name = "userJob" maxlength = "20">
					</div>
					...
					<div class="form-group userBirthday">			
						<input type = "text" class = "form-control" placeholder = "생년월일(ex.93.03.25)" name = "userBirthday" maxlength = "20">
					</div>
					<div class="form-group  userPhoneNumber">			
						<input type = "text" class = "form-control" placeholder = "핸드폰 번호" name = "userPhoneNumber" maxlength = "20">
					</div>
