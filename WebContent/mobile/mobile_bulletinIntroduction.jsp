...
<body>
	...
	<div class = "container-main">
			<div class="btn-group" role="group" aria-label="...">
			  ...
			  <a type="button" class="btn btn-default active" href="mobile_bulletinIntroduction.jsp">가입인사</a>
		...
		<div class = "row">
			...
			<table class = "table table-hover list">
				...
				%>
					<tr>
						<td colspan='2'><a class="title-line" href="mobile_bulletinIntroductionView.jsp?bulletinID=<%=list.get(i).getBulletinID()%>"> <%= list.get(i).getBulletinTitle() %></a></td>
					</tr>
					<tr>
			...
			%>
			<a href = "mobile_bulletinIntroduction.jsp?pageNumber=<%= pageNumber +1 %>" class= "btn btn-success btn-arrow-left pull-left">이전</a>
			...
			<%
				...
				if(pageNumber != 1){
			%>
			<a href = "mobile_bulletinIntroduction.jsp?pageNumber=<%= pageNumber -1 %>" class= "btn btn-success btn-arrow-left pull-left">다음</a>
			...
			<a href= "mobile_login.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	...
	<div class = "container-main">
		...
		<div class = "row">
			...
			<a href= "mobile_write.jsp"  onclick="btn_is_alert_click();" class="btn btn-primary pull-right">글쓰기</a>
		</div>
