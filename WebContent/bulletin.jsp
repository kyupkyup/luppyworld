	...
	<div class = "container">
		...
		<div class = "row">
			<table class = "table table-hover">
				...
				%>
					<tr class="table-body">
						<td><a href="bulletinView.jsp?bulletinID=<%=list.get(i).getBulletinID()%>"><%=list.get(i).getBulletinTitle() %></a></td>
			...
			%>
			<a href = "bulletin.jsp?pageNumber=<%= pageNumber +1 %>" class= "btn btn-success btn-arrow-left">이전</a>
			...
			<%
				...
				if(pageNumber != 1){
			%>
			<a href = "bulletin.jsp?pageNumber=<%= pageNumber -1 %>" class= "btn btn-success btn-arrow-left">다음</a>
