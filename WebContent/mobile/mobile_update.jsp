...
<body>
	...
	<div class = "container-main">
		<div class = "row">
			...
			<form method = "post" action="mobile_updateAction.jsp?bulletinID=<%=bulletinID%>" enctype="multipart/form-data">
				<table class = "table table-striped">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name = "bulletinContent" maxlength ="20000" style= "height: 350px;"><%=bulletin.getBulletinContent()%> </textarea></td>
						</tr>
