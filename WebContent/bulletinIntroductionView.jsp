		...
		<div class = "row">
				...
				<table class = "table table-bordered"style= "text-align : center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><img src="/upload/<%=bulletin.getFileRealName()%>" alt="이미지 없음" onerror="this.src='/css/images/logo.png'"class="image"></td>
				...
				<form method = "post" action="bulletinIntroductionReplyAction.jsp?bulletinID=<%=bulletinID%>">
				...
				<a href = "bulletinIntroduction.jsp" class = "btn btn-primary">목록으로</a>
