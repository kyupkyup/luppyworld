...
<!--                     <li class="dropdown">
	...
	<div class = "container">
		<div class = "row">
				...
				<form method = "post" action="bulletinReplyAction.jsp?bulletinID=<%=bulletinID%>">
				...
				<table class = "table table-bordered replied-cover"style= "text-align : center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td class="replied-content"><pre style="height:80ox;"><%=list1.get(i).getReplyContent()%></pre></td>
						</tr>
						<% 
						}
						%>
				...
				<a href = "bulletin.jsp" class = "btn btn-primary">목록으로</a>
