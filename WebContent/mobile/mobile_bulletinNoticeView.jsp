		...
		<div class = "row">
				...
				<table class = "table table-bordered view">
					...
					<tbody>
						...
						<tr>
							<td colspan='2'><div style="min-height: 200px; text-align: Left; word-break:break-all; word-wrap:break-word;white-space:pre-wrap;" class="bulletin-view-content"><%=bulletin.getBulletinContent()%></div></td>
						</tr>
						...
						<tr>
							<td colspan='2'><img src="/upload/<%=bulletin.getFileRealName()%>"onerror="this.src='/css/images/logo.png'" alt="images/logo.png" class="bulletin-view-image"></td>
								...
								<form method = "post" action="mobile_bulletinNoticeReplyAction.jsp?bulletinID=<%=bulletinID%>">
				...
				<a href = "mobile_bulletinNotice.jsp" class = "btn btn-primary">목록으로</a>
