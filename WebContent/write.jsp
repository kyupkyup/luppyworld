...
<link href="css/write_style.css" rel="stylesheet">
		...
		<div class = "row">
			...
			<form method = "post" action="writeAction.jsp" enctype="multipart/form-data">
				<table class = "table table-striped"style= "text-align : center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr class="title">
							<td><input type ="text" class="form-control" placeholder="글 제목" name = "bulletinTitle" maxlength ="50" value="NULL"></input></td>
						</tr>
						...
						<tr class="content">
							<td><textarea class="form-control" placeholder="글 내용" name = "bulletinContent" maxlength ="50000" style= "height: 350px; "> </textarea></td>
						</tr>
